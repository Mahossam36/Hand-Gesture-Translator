...
with open(r'E:\Github\Hand_Gesture\Models\digits_model.p', 'rb') as f:
...
with open(r'E:\Github\Hand_Gesture\Models\model.p', 'rb') as f:
...
with open(r'E:\Github\Hand_Gesture\Models\arabic_model.pkl', 'rb') as f:
...
with open(r'E:\Github\Hand_Gesture\Models\svm_model_with_labels.pkl', 'rb') as f:
...
class MainApp:
    def __init__(self, root):
        ...
        # Background Image
        try:
            self.bg_image = Image.open(r"E:\Github\Hand_Gesture\Extra_material\Letters_Images\Gemini_Generated_Image_l7kov8l7kov8l7ko.jpeg")
